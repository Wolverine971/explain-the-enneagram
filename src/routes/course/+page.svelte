<svelte:head>
  <title>Free Email Course - Explain the Enneagram</title>
  <meta
    name="description"
    content="The Practitioner's Guide to Explaining the Enneagram: Learn the common mistakes coaches make and how to fix them. 5 lessons delivered by email."
  />
  <link rel="canonical" href="https://www.explaintheenneagram.com/course" />

  <meta property="og:site_name" content="Explain the Enneagram" />
  <meta property="og:title" content="The Practitioner's Guide to Explaining the Enneagram" />
  <meta
    property="og:description"
    content="5 short emails. 5 lessons. Learn the common mistakes coaches make when explaining the Enneagram and how to fix them."
  />
  <meta property="og:url" content="https://www.explaintheenneagram.com/course" />
    ...
    <svg
      ...
      ></path><defs
        ><linearGradient
          ...
          ><stop style="stop-color:#45244A"></stop><stop
            offset="1"
            style="stop-color:#f0dff7"
          ></stop></linearGradient
        ></defs
      ></svg
    >
    <div style="background-color:#ffffff" class="formkit-bg-color"></div>
    <div
      style="background-image:url();opacity:0.45;background-color:#ffffff"
      class="formkit-bg-image"
    ></div>
    <div class="formkit-container">
      <div
        class="formkit-form-container"
        role="complementary"
      ...
      >
        ...
        <div
          class="formkit-image-tag"
          style="color:#ffffff;background-color:#000000;font-weight:700;text-transform:uppercase"
        >
          <p>Free EMAIL COURSE</p>
        </div>
        <div class="formkit-form-content-container" style="border-radius:10px">
          <div
            class="formkit-form-heading"
          ...
          <form
            method="POST"
            action="https://app.convertkit.com/forms/6714407/subscriptions"
            data-sv-form="6714407"
            data-uid="299029befe"
            class="formkit-form"
          >
            <ul
              ...
              data-group="alert"
            ></ul>
            <div class="formkit-fields" style="color:#000000">
              ...
              <button
                ...
                style="color:#ffffff;background-color:#45244A;border-radius:5px;font-size:16px;font-weight:700;letter-spacing:1px"
                data-element="submit"
                ...
                <span>Get the free course</span></button
              >
            </div>
          </form>
          <div class="formkit-disclaimer" style="color:#666666">
            I won’t send you spam. Unsubscribe anytime.
          </div>
        </div>
      </div>
      <div class="formkit-content-container" role="main">
        <header>
          <div
            class="formkit-heading"
            style="color:#000000;font-weight:700;text-transform:none"
          >
            <h1 style="text-align:center">The Enneagram Coach's Checklist</h1>
          </div>
        </header>
        <div class="formkit-subheading">
          <div
            class="formkit-text"
            style="color:#111111"
            data-type="Text"
...
</ul><p></p><p><strong>Written by DJ Wayne, </strong><u><strong>an average guy who has been deep into the Enneagram since 2017</strong></u>
...
"
          ...
          >
            ...
            <p>
              <strong>Written by DJ Wayne, </strong><u
                ><strong
                  >an average guy who has been deep into the Enneagram since 2017</strong
                ></u
              ><strong>, and has...</strong>
            </p>
            <ul class="unordered_list" style="list-style-position:inside">
              <li class="list_item">
                <span>written 100+ articles</span>
              </li>
              <li class="list_item">
                <span>explained it to everyone he knows</span>
              </li>
              <li class="list_item">
                <span
                  >and is ready to <u><strong>share everything</strong></u
                  ></span
                >
              </li>
            </ul>
    ...
    <!-- <div class="formkit-powered-by-convertkit-container" style="display:none">
      <a
        ...
        data-variant="dark"
        target="_blank">Powered By ConvertKit</a
      >
    </div> -->
  </div>
</div>
...
*/
  ...
  :root {
    ...
    --gradient_one-background-color: #45244a;
    --gradient_two-background-color: #f0dff7;
    --background-background-image: url();
    --background-opacity: 0.45;
    --background-background-color: #ffffff;
    --form_border_radius-border-radius: 10px;
    --form_background-background-color: #ffffff;
    --image_text-color: #ffffff;
    --image_text-background-color: #000000;
    --image_text-font-weight: 700;
    --image_text-text-transform: uppercase;
    --form_heading-color: #000000;
    --form_heading-font-weight: 700;
    --form_content_text-color: #000000;
    --field-font-size: 16px;
    --field-background-color: #ffffff;
    --field-color: #45244a;
    --field-font-weight: 400;
    --field-border-color: #45244a;
    --field-border-radius: 5px;
    --button-color: #ffffff;
    --button-background-color: #45244a;
    ...
    --subheading_text-color: #111111;
    --content_text-color: #111111;
  }
  .formkit-page {
